...
Future<void> main(List<String> args) async {
  if (args.isEmpty) {
    developer.log('Usage: dart run scripts/model_downloader_cli.dart <gemma|exaone>');
    exit(0);
  }
  ...
  switch (args.first.toLowerCase()) {
    ...
    case 'exaone':
      ...
      break;
    default:
      developer.log('Unknown model: ${args.first}');
      exit(1);
  }

  developer.log('Starting download for $type');
